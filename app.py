...
@app.route('/searches', methods=['POST', 'GET'])  # route to show the top searches in a web UI
@cross_origin()
def top_searches():
    if request.method == 'POST':
        try:
            ...
            for box in sub_box:
                ...
                mydict = {"thumb": b_thumb, "Name": productName, "Rating": overallRating, "Price": productPrice,
                          "Link": productLink}
